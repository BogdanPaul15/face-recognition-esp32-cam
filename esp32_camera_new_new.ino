...
static camera_config_t camera_config = {
    ...
    .pixel_format = PIXFORMAT_JPEG, // 230KB RAW -> ~15KB JPEG
...
void loop()
{
    ...
    signal.get_d+9ata = &ei_camera_get_data;
    ...
    if (bogdan_confidence > 0.5) {
        ...
        int servo_angle = map(center_x, 0, EI_CLASSIFIER_INPUT_WIDTH, 150, 30);
